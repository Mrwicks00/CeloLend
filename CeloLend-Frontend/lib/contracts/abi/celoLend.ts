export const CELO_LEND_ABI = [
  ...
  {
    "inputs": [],
    "name": "getActiveLoanRequestsWithDetails",
    "outputs": [
      {
        "components": [
          {
        ...
        "internalType": "struct CeloLend.LoanRequest[]",
        "name": "",
        "type": "tuple[]"
      }
    ],
  ...
  },
  {
    ...
    "outputs": [
      ...
      {
        "internalType": "uint256",
        "name": "loanTokenVolatility",
        "type": "uint256"
      },
      {
        "internalType": "uint256",
        "name": "collateralVolatility",
        "type": "uint256"
      },
      {
        "internalType": "bool",
        "name": "isLoanTokenStablecoin",
        "type": "bool"
      },
      {
        "internalType": "bool",
        "name": "isCollateralStablecoin",
        "type": "bool"
      },
      {
        "internalType": "uint256",
  ...
  },
  {
    ...
    "outputs": [
      {
        "internalType": "uint256",
        "name": "totalRequestsForToken",
        "type": "uint256"
      },
      {
        "internalType": "uint256",
        "name": "totalVolumeForToken",
        "type": "uint256"
      },
      {
        "internalType": "uint256",
  ...
  {
    "inputs": [],
    "name": "mentoIntegration",
    "outputs": [
      {
        "internalType": "contract MentoIntegration",
        "name": "",
        "type": "address"
      }
    ],
