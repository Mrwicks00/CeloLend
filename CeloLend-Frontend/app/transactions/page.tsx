...
export default function TransactionsPage() {
  ...
  const transactions: Transaction[] = [
    ...
    },
    {
      ...
      gasFee: 12.3,
      description:
        "Attempted collateral withdrawal - insufficient health factor",
    },
  ];
  ...
  const notifications: Notification[] = [
    {
      ...
      message:
        "Your loan of 5000 USDC is due in 3 days. Please ensure sufficient funds for repayment.",
    ...
    },
    {
      ...
      message:
        "Your ETH collateral health factor has dropped to 1.3. Consider adding more collateral.",
                        ...
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            ...
                            <div className="flex items-center space-x-4 mt-1 text-xs text-gray-500">
                              ...
                              {transaction.gasFee && (
                                <span>Gas: ${transaction.gasFee}</span>
                              )}
                            </div>
                          </div>
                        </div>
